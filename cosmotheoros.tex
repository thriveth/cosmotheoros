...
\setmainfont[
	     ...
	     %Style=Historic,
	     Variant=0,
	     BoldFont={EB Garamond 08 Regular},
	     ]{EB Garamond}%{Junicode}%{Adobe Caslon Pro}%{Linux Libertine O}% {Garamond Premier Pro}%{Fanwood}%{OFL Sorts Mill Goudy}%\usepackage{xunicode}
\usepackage{xltxtra}
\usepackage{graphicx}
...
{\fontsize{42}{42} \fontspec{EB Garamond}Celeſtial Worlds} \\
\small \phantom{bla bla}
\LARGE DISCOVER'D: \\
OR, \\
\fontsize{36}{36} \fontspec{EB Garamond} \textsc{conjectures} \\
\tiny \phantom{bla bla}
\LARGE Concerning the \\
\fontsize{36}{36} \fontspec{EB Garamond} \textsc{inhabitants,} \\
\tiny \phantom{bla bla}
